BuckleoAnimationIdle:    INCLUDE "gfx/pokemon/no_idle.asm"
WoffAnimationIdle:       INCLUDE "gfx/pokemon/no_idle.asm"
VantaroAnimationIdle:    INCLUDE "gfx/pokemon/no_idle.asm"
